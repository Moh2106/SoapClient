 ...
 * generated in the ma.enset.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetComptes_QNAME = new QName("http://webService.enset.ma/", "getComptes");
    private final static QName _GetComptesResponse_QNAME = new QName("http://webService.enset.ma/", "getComptesResponse");
    private final static QName _Conversion_QNAME = new QName("http://webService.enset.ma/", "conversion");
    private final static QName _GetCompteResponse_QNAME = new QName("http://webService.enset.ma/", "getCompteResponse");
    private final static QName _ConversionResponse_QNAME = new QName("http://webService.enset.ma/", "conversionResponse");
    private final static QName _GetCompte_QNAME = new QName("http://webService.enset.ma/", "getCompte");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ma.enset.proxy
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.enset.ma/", name = "getComptes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.enset.ma/", name = "getComptesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.enset.ma/", name = "conversion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.enset.ma/", name = "getCompteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.enset.ma/", name = "conversionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.enset.ma/", name = "getCompte")
