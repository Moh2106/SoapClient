 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://webService.enset.ma/", wsdlLocation = "http://localhost:1234/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://webService.enset.ma/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1234/BanqueWS?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://webService.enset.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.enset.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
